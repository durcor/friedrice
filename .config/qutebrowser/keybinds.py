...
config.bind('M','spawn -d i3 split v ;; hint links spawn -d st -e buku -w nvim -a {hint-url}')
...
config.bind('zpt', 'set content.proxy socks://localhost:9050')
config.bind('zps', 'set content.proxy system')
...
config.bind('m','spawn -d i3 split v ;; spawn -d st -e buku -w nvim -a {url}')
...
config.bind('yb','spawn -d i3 split v ;; hint links spawn -d st -e buku -w nvim -a {hint-url}')
# config.bind('yb','hint links spawn -d tmux neww buku -w nvim -a {hint-url}')
