...
config.bind('M','spawn -d i3 split v ;; hint links spawn -d st -e buku -w -a {hint-url}')
...
config.bind('m','spawn -d i3 split v ;; spawn -d st -e buku -w -a {url}')
...
config.bind('yb','spawn -d i3 split v ;; hint links spawn -d st -e buku -w -a {hint-url}')
