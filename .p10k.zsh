# Generated by Powerlevel10k configuration wizard on 2020-07-04 at 12:09 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%B%14F┏'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%B%14F┟'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%B%14F┗'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=11
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%Bλ'
  ...
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=13
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%F{13}@%F{12}%m'
